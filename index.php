                    ...
                    <div class="zone-post">
                        <div class="post">
                            ...
                            if(isset($_FILES['file'])) {
                                ...
                                $pdo->exec("INSERT INTO poste (message,date,tag,pseudo) VALUES ('$_POST[message]',NOW(),'$_POST[tag]','$_SESSION[pseudo]')");
                                header('Location: index.php');
                                }
                            ...
                            $r = $pdo->query('SELECT * FROM poste ORDER BY date DESC');
                            while($message = $r->fetch(PDO::FETCH_ASSOC)){ ?>
                                <br>
                                <div class="top-post">
                                    <div class="bot-post"> 
                                        <p class="pseudo-post"><?php echo $message['pseudo']; ?></p> 
                                        <p class="date-post"><?php echo '('.$message['date'].')'; ?></p>
                                    </div>
                                    
                                    <p class="tag-post"><?php echo $message['tag']; ?></p>
                                    ...
                                    <?php if ($message['pseudo'] === $data['pseudo']) { ?>
                                        <div class="pb">
                                        <a href="supprimer.php?id=<?php echo $message['id_post'] ?>" class="delete-link">
        ...
        <div>
                    ...
                    <div class="popup" id="popup">
                        ...
                        <form method="post" class="sup" id="myForm" enctype="multipart/form-data">
                            ...
                            <input  accept="image/jpeg, image/png, image/gif" class="fichier" id="file" type="file" name="file">
                            <br><br>
