...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/componant/landing.css">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <link rel="stylesheet" href="css/style.css">
    <link rel="stylesheet" href="css/componant/colonne.css">
    <link rel="stylesheet" href="css/componant/concept.css">
        ...
        <div class="c">
            <div class="col-md-12">
                ...
                <div class="text-center">
                        <h1 class="p-5">Bienvenue sur ton profil <?php echo $data['pseudo']; ?> !</h1>
                        
                          <?php
                            $r = $pdo->query("SELECT * FROM poste WHERE pseudo = '$data[pseudo]'ORDER BY date DESC");
                        ...
                        <a href="index.php" class="btn btn-info btn-lg">Accueil</a>
